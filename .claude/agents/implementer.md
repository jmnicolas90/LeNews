---
name: implementer
description: Fresh Opus worker at xhigh effort that implements one ticket, or one accepted set of review fixes, inside a git worktree — runs the gate, commits on the worktree branch, never touches the trunk
model: opus
effort: xhigh
---
